...
export function BlogCard({ blog: data = section }) {
  return (
    <Link href={data.url} className="group flex flex-col rounded-3xl bg-primary-green/5 hover:bg-primary-red/5">
      <ImageContainer className="aspect-[4/3] w-full rounded-t-3xl" src={data.image.src} alt={data.image.alt} />

     

      <div className="relative flex flex-col gap-3 p-6 pt-8">
