            ...
            <div className="grid grid-cols-[1fr_1fr] items-center gap-[70px]">
                <div>
                    ...
                    <p className="mt-[32px] max-w-[720px] text-[22pt] leading-[1.6] text-[#555555]">
                        Empowering you with practical training, experienced
                        instructors, and career-focused learning to help you
                ...
                <div className="grid grid-cols-[1.15fr_1fr] gap-[14px]">
                    <div className="flex flex-col gap-[14px]">
                        ...
                        <div className="flex w-[400px] items-center justify-center gap-4 rounded-[10px] bg-[#F2F6FF] p-[10px]">
                            ...
                            <div>
                                <div className="text-[30pt] leading-none font-black text-black">
                                    1500+
                                </div>

                                <div className="mt-1 text-[25pt] font-bold text-black">
                                    Students Enrolled
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="flex flex-col gap-[14px]">
                        ...
                        <div className="flex items-center gap-4 rounded-[10px] bg-[#F2F6FF] p-[10px]">
                            <GraduationCap className="size-12 fill-[#062D83] text-[#062D83] h-20" />

                            <div>
                                <div className="text-[30pt] text-black leading-none font-black">
                                    6+
                                </div>
