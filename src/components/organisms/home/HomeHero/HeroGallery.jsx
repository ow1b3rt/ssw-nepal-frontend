...
const section = {
  image1: { src: "/images/home/building.jpg", alt: "helo" },
  text1: { icon: "IdCard", number: 20, label: "Experts" },
  image2: { src: "/images/home/homeaward.jpg", alt: "helo" },
  text2: { icon: "GraduationCap", number: 1500, label: "Students Enrolled" },
  image3: { src: "/images/home/homeclass.jpg", alt: "helo" },
  doubleImage: [
    { src: "/images/home/office.jpg", alt: "helo" },
    { src: "/images/home/team.jpg", alt: "helo" },
  ],
...
export function ImageContainer({ className, ...props }) {
  return (
    ...
    >
      <Image height={1600} width={900} className="h-full" alt="ssw-nepal" {...props} />
    </AnimatedCard>
  );
}
...
function StatCard({ icon, number, label }) {
  ...
  return (
    ...
    >
      {Icon && (
        <div className="bg-primary-blue flex h-10 w-10 items-center justify-center rounded-lg">
          <Icon className="size-8 text-white" />
        </div>
      )}
      <div>
        <p className="text-xl font-extrabold md:text-4xl">
