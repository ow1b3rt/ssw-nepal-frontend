...
export default function NotFound() {
  return (
    <div className="container mx-auto flex min-h-screen flex-col items-center justify-center p-6 text-center">
      ...
      <h2 className="text-foreground mt-4 text-5xl font-bold">Page Not Found</h2>
      <p className="text-themeBlack/70 mt-2 text-center text-xl">
        The page you&apos;re looking for doesn&apos;t exist or may have been moved. Return to the
        homepage or use the navigation menu to find what you need.
      </p>
      <Link
        href="/"
